...
$hari_ini = date('Y-m-d');
$awal_tahun = date('Y-01-01'); // Hari pertama tahun ini
$akhir_tahun = date('Y-12-31'); // Hari terakhir tahun ini
...
class PDF extends FPDF
{
    ...
    function Header()
    {
        ...
        $this->Cell(0, 10, 'LAPORAN KEGIATAN TAHUNAN', 0, 1, 'C');
...
if (!empty($data_kegiatan)) {
    ...
    $pdf->Cell(0, 10, 'Tidak ada data kegiatan untuk tahun ini.', 1, 1, 'C');
}
