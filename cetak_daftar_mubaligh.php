...
// Query untuk mengambil data mubaligh dan data masjid
$query = $conn->prepare("SELECT 
        m.nama_masjid, 
        m.alamat_masjid, 
        mb.nama_mubaligh, 
        mb.alamat_mubaligh, 
        mb.no_telepon_mubaligh 
    FROM mubaligh mb
...
class PDF extends FPDF
{
    ...
    function Header()
    {
        ...
        $this->Cell(52, 10, 'Alamat', 1, 0, 'C');
        $this->Cell(40, 10, 'No. Telepon', 1, 1, 'C');
    }
...
if (!empty($data_mubaligh)) {
    ...
    foreach ($data_mubaligh as $mubaligh) {
        ...
        $pdf->Cell(83, 10, $mubaligh['nama_mubaligh'], 1, 0, 'L');
        $pdf->Cell(52, 10, $mubaligh['alamat_mubaligh'], 1, 0, 'L');
        $pdf->Cell(40, 10, $mubaligh['no_telepon_mubaligh'], 1, 1, 'C');
    }
} else {
