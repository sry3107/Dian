...
if (!empty($query)) {
    $stmt = $conn->prepare("SELECT k.tanggal_kegiatan, k.waktu_kegiatan, mu.nama_mubaligh
        FROM jadwal j
        ...
        <div class="max-w-7xl mx-auto px-6">
            <div class="flex justify-between items-center mb-8">
                ...
                <div class="flex items-center gap-4">
                    ...
                    <a href="cetak_khutbah_jumat_public.php" class="text-white bg-green-500 hover:bg-green-600 flex items-center gap-2 rounded-full py-2 px-4 shadow-lg" title="Cetak Daftar Khutbah Jum'at">
                        <i class="fas fa-print"></i>
                        <span>Daftar</span>
                    </a>
                    <!-- Tombol Print Laporan Jadwal Khutbah Jum'at Tahunan -->
                    <a href="laporan_jadwal_khutbah_jumat_tahunan_public.php" class="text-white bg-green-500 hover:bg-green-600 flex items-center gap-2 rounded-full py-2 px-4 shadow-lg" title="Cetak Laporan Khutbah Jum'at Tahunan">
                        <i class="fas fa-print"></i>
                        <span>Laporan</span>
                    </a>
                </div>
                    ...
                    .then(data => {
                        if (data.length > 0) {
                            ...
                            data.forEach(item => {
                                ...
                                // Klik akan mengarahkan ke khutbah_jumat_mubaligh.php
                                resultDiv.addEventListener("click", function () {
                                    window.location.href = `khutbah_jumat_mubaligh.php?query=${encodeURIComponent(query)}`;
                                });
