...
class PDF extends FPDF
{
    ...
    function Header()
    {
        ...
        $this->Cell(60, 10, 'Nama Pengurus', 1, 0, 'C');
        $this->Cell(32, 10, 'Jabatan', 1, 0, 'C');
        $this->Cell(50, 10, 'Alamat', 1, 0, 'C');
        $this->Cell(38, 10, 'No. Telepon', 1, 1, 'C');
    }
...
if (!empty($data)) {
    ...
    foreach ($data as $pengurus) {
        ...
        $pdf->Cell(60, 10, $pengurus['nama_pengurus'], 1, 0, 'L');
        $pdf->Cell(32, 10, $pengurus['jabatan_pengurus'], 1, 0, 'L');
        $pdf->Cell(50, 10, $pengurus['alamat_pengurus'], 1, 0, 'L');
        $pdf->Cell(38, 10, $pengurus['no_telepon_pengurus'], 1, 1, 'C');
    }
} else {
