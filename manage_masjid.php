    ...
    <section class="card py-16">
        <div class="max-w-7xl mx-auto px-6">
            <div class="flex justify-between items-center mb-8">
                ...
                <?php
                // Cek apakah data masjid sudah ada
                $queryCheck = "SELECT COUNT(*) AS total FROM masjid";
                $resultCheck = $conn->query($queryCheck);
                $dataCheck = $resultCheck->fetch_assoc();

                // Tampilkan tombol hanya jika belum ada data masjid
                if ($dataCheck['total'] == 0): ?>
                    <!-- Icon Input Data -->
                    <a href="edit_masjid.php" class="text-white bg-green-500 hover:bg-green-600 rounded-full p-3 shadow-lg" title="Input Data">
            ...
            <div class="card-hover bg-white rounded-xl overflow-hidden mb-4 shadow-md">
                <a href="edit_masjid.php?id=<?php echo $data['id_masjid']; ?>" class="block w-full h-full">
                    <div class="p-6">
                        ...
                        <div class="detail">
                            <table class="table-auto w-full">
                                <tbody>
                                    ...
                                    <tr class="border-b">
                                        <th class="text-left py-2 pr-4 font-medium">
                                            <i class="fas fa-map-marker-alt icon"></i> Alamat Masjid
                                        </th>
                                        <td class="py-2">: <?php echo htmlspecialchars($data['alamat_masjid']); ?></td>
                                    </tr>
                                    <tr>
                                        <th class="text-left py-2 pr-4 font-medium">
                                            <i class="fas fa-calendar-alt icon"></i> Tahun Berdiri
                                        </th>
            ...
            <div class="text-center">
                <p class="text-gray-500">Data masjid tidak tersedia. Lakukan input data!</p>
            </div>
            <?php endif; ?>
        </div>
    </section>
