...
class PDF extends FPDF
{
    ...
    function Header()
    {
        ...
        $this->Cell(0, 10, 'DAFTAR KEGIATAN MINGGUAN', 0, 1, 'C');
        ...
        $this->Cell(26, 10, 'Waktu', 1, 0, 'C');
        $this->Cell(62, 10, 'Kegiatan', 1, 0, 'C');
...
if (!empty($data_kegiatan)) {
    ...
    foreach ($data_kegiatan as $kegiatan) {
        ...
        $pdf->Cell(30, 10, $kegiatan['tanggal_kegiatan'], 1, 0, 'C');
        $pdf->Cell(26, 10, $kegiatan['waktu_kegiatan'], 1, 0, 'C');
        $pdf->Cell(62, 10, $kegiatan['nama_kegiatan'], 1, 0, 'L');
