            ...
            <?php if ($role === 'Pengurus'): ?>
                <div class="mb-6"> 
                    <div class="flex items-center gap-4">
                        ...
                        <a href="manage_artikel.php" class="text-white bg-green-500 hover:bg-green-600 rounded-full p-3 ml-auto shadow-lg" title="Tambah Artikel">
                    ...
                    <?php foreach ($data_artikel as $index => $row): ?>
                        <div class="bg-white shadow-md rounded-lg overflow-hidden flex flex-col justify-between">
                            ...
                            <div class="p-4 flex flex-col justify-between flex-grow">
                                ...
                                <!-- Tempat and Waktu at the Bottom -->
                                <div class="mt-auto">
                            ...
                            <div class="flex justify-between p-4 border-t bg-gray-50">
                                <a href="edit_artikel.php?id=<?= $row['id_artikel']; ?>" class="text-blue-600 hover:text-blue-800">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
                    <?php foreach ($data_artikel as $index => $row): ?>
                        <div class="bg-white shadow-md rounded-lg overflow-hidden">
                            <div class="p-4">
                                <h3 class="text-lg font-bold mb-2"><?= htmlspecialchars($row['judul_artikel'] ?? ''); ?></h3>
                                <p class="text-gray-700 mb-2"><?= htmlspecialchars($row['deskripsi_artikel']); ?></p>
                                <p class="text-sm text-gray-600 mb-1">
                                    <i class="fas fa-map-marker-alt"></i> <?= htmlspecialchars($row['tempat_artikel'] ?? ''); ?>
                                </p>
                                <p class="text-sm text-gray-600 mb-3">
