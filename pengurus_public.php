...
$data_pengurus = $result->fetch_all(MYSQLI_ASSOC);
                    ...
                    .then(data => {
                        if (data.length > 0) {
                            ...
                            data.forEach(item => {
                                ...
                                // Klik akan mengarahkan ke pengurus_public.php
                                resultDiv.addEventListener("click", function () {
                                    window.location.href = `pengurus_public.php?query=${encodeURIComponent(query)}`;
                                });
