        ...
        <div class="max-w-7xl mx-auto px-6">
            <div class="flex justify-between items-center mb-8">
                ...
                <div class="flex items-center gap-4">
                    ...
                    <a href="cetak_daftar_mubaligh_public.php" class="text-white bg-green-500 hover:bg-green-600 rounded-full p-3 shadow-lg" title="Cetak Daftar Mubaligh">
                    ...
                    .then(data => {
                        if (data.length > 0) {
                            ...
                            data.forEach(item => {
                                ...
                                // Klik akan mengarahkan ke mubaligh_public.php
                                resultDiv.addEventListener("click", function () {
                                    window.location.href = `mubaligh_public.php?query=${encodeURIComponent(query)}`;
                                });
