    ...
    <section class="card py-16">
        <div class="max-w-7xl mx-auto px-6">
            <div class="flex justify-between items-center mb-8">
                ...
                <a href="detail_profil_mubaligh.php" class="text-gray-500 hover:bg-gray-300 rounded-full p-3 shadow-lg" title="Kembali">
                    <i class="fas fa-arrow-left m-1"></i>
                </a>
            </div>
            <div class="card-hover bg-white rounded-xl overflow-hidden">
                <a href="edit_akun_mubaligh.php?id=<?php echo htmlspecialchars($data_akun['id_akun']); ?>" alt="Akun" class="block w-full h-full">
                    <div class="p-6">
