...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Periksa apakah kegiatan dengan kombinasi kode_kegiatan, waktu_kegiatan, dan tanggal_kegiatan sudah ada
    ...
    if ($row['count'] > 0) {
        ...
        echo "<script>alert('Kegiatan sudah ada. Silahkan buat kegiatan lain!'); window.location.href='tambah_kegiatan_mubaligh.php';</script>";
    } else {
        ...
        if ($query->execute()) {
            echo "<script>alert('Kegiatan berhasil dibuat!'); window.location.href='kegiatan_mubaligh.php';</script>";
        } else {
...
<div class="container">
    ...
    <form action="" method="post">
        ...
        <!-- Tombol Cancel -->
        <button type="button" onclick="location.href='kegiatan_mubaligh.php'" class="w-full bg-gray-500 text-white px-4 py-2 rounded hover:bg-gray-600 mt-4">Cancel</button>
    </div>
